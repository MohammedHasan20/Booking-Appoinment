...
const TopDoctors = () => {
  ...
  return (
    ...
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
        ...
        {/* Corrected grid-cols class using arbitrary values */}
        ...
        <button onClick={()=>{navigate('/doctors');scrollTo(0,0)}} className="mt-6 px-6 py-3 bg-indigo-600 text-white font-medium rounded-md shadow-md hover:bg-indigo-700 transition-colors duration-200">
          More Doctors
        </button>
    </div>
