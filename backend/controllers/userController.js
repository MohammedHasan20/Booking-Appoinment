...
const getProfile = async (req, res) => {
    try {
        const { userId } = req.user; // ✅ use req.user instead of req.body
...
const updateProfile = async (req, res) => {
    try {
        ...
        const imageFile = req.file; // ✅ multer stores in req.file
...
// API to get user appoinments for frontend my-appointments page
